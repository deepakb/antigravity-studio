...
> **Purpose**: Audit the UI for WCAG 2.2 AA accessibility compliance. Every user, regardless of ability, should be able to use @nexus/web fully. Accessibility is a legal requirement and a quality standard.
